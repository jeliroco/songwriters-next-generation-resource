  ...
  if (disabled) {
    ...
    return (
      <button
        ...
        className="px-4 py-2 text-xs font-bold text-white bg-blue-500 border-2 border-blue-600 rounded md:text-base hover:bg-blue-600 focus:bg-blue-700 hover:border-blue-700 focus:border-blue-800"
      >
        {children}
      </button>
    );
